...
from ..types import KageReplyMarkup, ListLike
...
async def answer(
    ...
    **kwargs,
    ...
    :param message: Message to answer to. Can be a tl message or kage inline object
    ...
    if isinstance(response, str) and not kwargs.pop("asfile", False):
        ...
        if len(text) >= 4096 and not hasattr(message, "kage_grepped"):
            try:
