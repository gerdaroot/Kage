...
from ..types import KageReplyMarkup
...
class Gallery(InlineUnit):
    async def gallery(
        ...
        *,
        custom_buttons: KageReplyMarkup | None = None,
        force_me: bool = False,
        ...
        :param gif: Whether the gallery will be filled with gifs. If you omit this argument and specify
                    gifs in `next_handler`, Kage will try to determine the filetype of these images
        :param manual_security: By default, Kage will try to inherit inline buttons security from the caller (command)
                                If you want to avoid this, pass `manual_security=True`
        :param disable_security: By default, Kage will try to inherit inline buttons security from the caller (command)
        ...
        with contextlib.suppress(AttributeError):
            _kage_client_id_logging_tag = copy.copy(self._client.tg_id)  # noqa: F841
