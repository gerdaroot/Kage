...
class Utils(InlineUnit):
    ...
    def _needs_premium_emoji_pre_edit(self, text: typing.Any) -> bool:
        return self._has_premium_emoji(text) and bool(
            getattr(getattr(self._client, "kage_me", None), "premium", False)
        )
    ...
    def _generate_markup(
        self: "InlineManager",
        markup_obj: KageReplyMarkup | str | None,
    ...
    def _normalize_markup(
        self: "InlineManager", reply_markup: KageReplyMarkup
