...
class _InlineFormDraft:
    ...
    def __init__(self):
        ...
        self.reply_markup: KageReplyMarkup | None = None
...
@loader.tds
class KageConfigMod(loader.Module):
    """Interactive configurator for Kage Userbot"""

    strings = {"name": "KageConfig"}
    ...
    def _category_option(
        ...
        if option in KageConfigMod._config_categories(instance).get(category, []):
            return option
