...
@loader.tds
class KageInfoMod(loader.Module):
    """Show userbot info"""

    strings = {"name": "KageInfo"}
    ...
    def __init__(self):
        self.config = loader.ModuleConfig(
            ...
            loader.ConfigValue(
                "banner_url",
                "https://raw.githubusercontent.com/gerdaroot/Kage/master/assets/img/info.png",
    ...
    async def _render_info(self, start: float) -> str:
        ...
        me = (
            '<b><a href="tg://user?id={}">{}</a></b>'.format(
                self._client.kage_me.id,
                utils.escape_html(get_display_name(self._client.kage_me)),
            )
            .replace("{", "")
            .replace("}", "")
        )
        ...
        return (
            ...
            if self.config["custom_message"]
                ...
                (
                    ...
                    if self._client.kage_me.premium and self.config["show_kage"]
                    else ""
                ),
                me=me,
                version=_version,
