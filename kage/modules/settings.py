...
class CoreMod(loader.Module):
    ...
    async def kagecmd(self, message: Message):
        ...
        await utils.answer(
            ...
            + (branch_text),
            file="https://raw.githubusercontent.com/gerdaroot/Kage/master/assets/img/version.png",
    ...
    async def togglecmdcmd(self, message: Message):
        ...
        if cmd.lower() not in [c.lower() for c in mod_inst.kage_commands.keys()]:
    ...
    async def installationcmd(self, message: Message):
        ...
        if (
            ...
            await self.inline.form(
                ...
                photo="https://raw.githubusercontent.com/gerdaroot/Kage/master/assets/img/installation.png",
            )
        ):

            await self.client.send_file(
                message.peer_id,
                "https://raw.githubusercontent.com/gerdaroot/Kage/master/assets/img/installation.png",
