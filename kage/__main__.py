...
if (
    ...
    print("\U0001f6ab" * 15)
    print("You attempted to run Kage on behalf of root user")
...
if sys.version_info < (3, 10, 0):
    ...
    if "KAGE_DO_NOT_RESTART" in os.environ:
        del os.environ["KAGE_DO_NOT_RESTART"]
    if "KAGE_DO_NOT_RESTART2" in os.environ:
        del os.environ["KAGE_DO_NOT_RESTART2"]
